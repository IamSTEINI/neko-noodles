...
func tutorial():
	...
	await Speaking.say(tr("TUTORIAL_1"))
	await Speaking.say(tr("TUTORIAL_2"))
	Speaking.show_tip(1)
	tutarrow_pos = Vector2(1396.0,48)
	await Speaking.say(tr("TUTORIAL_3"))
	tutarrow_pos = Vector2(208,42)
	await Speaking.say(tr("TUTORIAL_4"))
	tutarrow_pos = Vector2(208,165)
	Speaking.show_tip(2)
	await Speaking.say(tr("TUTORIAL_5"))
	tutarrow_pos = Vector2(0,42)
	await Speaking.say(tr("TUTORIAL_6"))
	tutarrow_pos = Vector2(154,42)
	Speaking.show_tip(3)
	await Speaking.say(tr("TUTORIAL_7"))
	tutarrow_pos = Vector2(0,42)
	await Speaking.say(tr("TUTORIAL_8"))
	Speaking.show_tip(4)
	tutarrow_pos = Vector2(0,42)
	await Speaking.say(tr("TUTORIAL_9"))
